			...
			case Rmi_recvString:
				{
					...
					int num; __msg >> num;
					m_core->PostCheckReadMessage(__msg,RmiName_recvString);
					...
					if(m_enableNotifyCallFromStub && !m_internalUse)
					{
						...
						NotifyCallFromStub(remote, (::Proud::RmiID)Rmi_recvString, 
							RmiName_recvString,parameterString);
			
			#ifdef VIZAGENT
						m_core->Viz_NotifyRecvToStub(remote, (::Proud::RmiID)Rmi_recvString, 
							RmiName_recvString, parameterString);
			#endif
					}
					...
					if(!m_internalUse && m_enableStubProfiling)
					{
						...
						summary.m_rmiID = (::Proud::RmiID)Rmi_recvString;
						summary.m_rmiName = RmiName_recvString;
					...
					// Call this method.
					bool __ret = recvString (remote,ctx , txt, num );
						
					if(__ret==false)
					{
						// Error: RMI function that a user did not create has been called. 
						m_core->ShowNotImplementedRmiWarning(RmiName_recvString);
					}
...
__fail:
	...
	const PNTCHAR* Stub::RmiName_recvString =_PNT("recvString");
	#else
	const PNTCHAR* Stub::RmiName_recvString =_PNT("");
	#endif
	const PNTCHAR* Stub::RmiName_First = RmiName_recvString;
