			...
			case Rmi_Chat:
				{
					...
					if(m_enableNotifyCallFromStub && !m_internalUse)
					{
						...
						::Proud::AppendTextOut(parameterString,str);	
										
						parameterString += _PNT(", ");
						::Proud::AppendTextOut(parameterString,num);	
					...
					// Call this method.
					bool __ret = Chat (remote,ctx , str, num );
			...
			case Rmi_Send:
				{
					...
					Proud::String str; __msg >> str;
					int num; __msg >> num;
					Proud::String sendTime; __msg >> sendTime;
					m_core->PostCheckReadMessage(__msg,RmiName_Send);
					...
					if(m_enableNotifyCallFromStub && !m_internalUse)
					{
						...
						parameterString += _PNT(", ");
						::Proud::AppendTextOut(parameterString,sendTime);	
						
						NotifyCallFromStub(remote, (::Proud::RmiID)Rmi_Send, 
							RmiName_Send,parameterString);
			
			#ifdef VIZAGENT
						m_core->Viz_NotifyRecvToStub(remote, (::Proud::RmiID)Rmi_Send, 
							RmiName_Send, parameterString);
			#endif
					}
					else if(!m_internalUse)
					...
					{
						::Proud::BeforeRmiSummary summary;
						summary.m_rmiID = (::Proud::RmiID)Rmi_Send;
						summary.m_rmiName = RmiName_Send;
						summary.m_hostID = remote;
						summary.m_hostTag = hostTag;
						BeforeRmiInvocation(summary);
					...
					// Call this method.
					bool __ret = Send (remote,ctx , str, num, sendTime );
						
					if(__ret==false)
					{
						// Error: RMI function that a user did not create has been called. 
						m_core->ShowNotImplementedRmiWarning(RmiName_Send);
					}
			...
			case Rmi_Quit:
				{
					...
					Proud::String dlg; __msg >> dlg;
					m_core->PostCheckReadMessage(__msg,RmiName_Quit);
					...
					if(m_enableNotifyCallFromStub && !m_internalUse)
					{
						...
						::Proud::AppendTextOut(parameterString,dlg);	
						
						NotifyCallFromStub(remote, (::Proud::RmiID)Rmi_Quit, 
							RmiName_Quit,parameterString);
			
			#ifdef VIZAGENT
						m_core->Viz_NotifyRecvToStub(remote, (::Proud::RmiID)Rmi_Quit, 
							RmiName_Quit, parameterString);
			#endif
					}
					else if(!m_internalUse)
					...
					{
						::Proud::BeforeRmiSummary summary;
						summary.m_rmiID = (::Proud::RmiID)Rmi_Quit;
						summary.m_rmiName = RmiName_Quit;
						summary.m_hostID = remote;
						summary.m_hostTag = hostTag;
						BeforeRmiInvocation(summary);
					...
					// Call this method.
					bool __ret = Quit (remote,ctx , dlg );
						
					if(__ret==false)
					{
						// Error: RMI function that a user did not create has been called. 
						m_core->ShowNotImplementedRmiWarning(RmiName_Quit);
					}
...
__fail:
	...
	#endif
	#ifdef USE_RMI_NAME_STRING
	const PNTCHAR* Stub::RmiName_Send =_PNT("Send");
	#else
	const PNTCHAR* Stub::RmiName_Send =_PNT("");
	#endif
	#ifdef USE_RMI_NAME_STRING
	const PNTCHAR* Stub::RmiName_Quit =_PNT("Quit");
	#else
	const PNTCHAR* Stub::RmiName_Quit =_PNT("");
	#endif
